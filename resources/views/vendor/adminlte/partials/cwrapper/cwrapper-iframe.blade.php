...
<div class="content-wrapper iframe-mode {{ config('adminlte.classes_content_wrapper', '') }}" data-widget="iframe" data-auto-show-new-tab="{{ config('adminlte.iframe.options.auto_show_new_tab', true) }}" data-loading-screen="{{ config('adminlte.iframe.options.loading_screen', true) }}" data-use-navbar-items="{{ config('adminlte.iframe.options.use_navbar_items', true) }}">
    ...
    <div class="nav navbar navbar-expand navbar-white navbar-light border-bottom p-0">
        ...
        <div class="nav-item dropdown">
            <a class="nav-link bg-danger dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <ul class="navbar-nav overflow-hidden" role="tablist">
            ...
            <li class="nav-item active" role="presentation">
                ...
                <a id="tab-default" class="nav-link active" data-toggle="row" href="#panel-default" role="tab" aria-controls="panel-default" aria-selected="true">
